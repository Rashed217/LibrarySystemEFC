...
using LibrarySystemEFC.Repositories;
...
namespace LibrarySystemEFC
{
    public class Program
    {
        ...
        // Admin Mode
        public static void AdminMode(LibraryContext context)
        {
        ...
        // Admin Actions
        public static void ViewBooks(LibraryContext context)
        {
        ...
        public static void UpdateBook(LibraryContext context)
        {
            var bookRepo = new BookRepository(context);
        ...
        public static void DeleteBook(LibraryContext context)
        {
            var bookRepo = new BookRepository(context);
        ...
        // User Mode
        public static void UserMode(LibraryContext context)
        {
        ...
        // User Actions
        public static void BorrowBook(LibraryContext context, User user)
        {
            var bookRepo = new BookRepository(context);
        ...
        public static void ReturnBook(LibraryContext context, User user)
        {
            var borrowingRepo = new BorrowingRepository(context);
